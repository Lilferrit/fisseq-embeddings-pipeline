...
# doesn't install the `dinov2` package itself (see VENDORED_FROM.md for
# why). Everything else in this file is unchanged. This file is excluded
# from ruff (pyproject.toml) so isort/format don't further drift it from
# upstream.
