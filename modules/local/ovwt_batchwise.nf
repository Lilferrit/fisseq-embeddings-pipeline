...
// (small) Nextflow run per IMPLEMENTATION_CHECKLIST.md Epic 9 / Epic 6
// Story 6.5's last bullet. The script block below already matches
// OvwtEmbeddingConfig's CLI contract exactly.
