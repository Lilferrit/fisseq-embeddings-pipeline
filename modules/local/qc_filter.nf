...
// `variant_barcode_count_threshold` (params.yaml's own key names) --
// mapped explicitly below.
//
// `label_column` reuses `params.filter_label_column` (same param
// FILTER_EMBEDDINGS/AGGREGATE_EMBEDDINGS/OVWT_BATCHWISE/the two global
